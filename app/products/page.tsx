            ...
            <tbody>
              <tr className="border-b dark:border-gray-700">
                ...
                <td className="px-4 py-3 max-w-[12rem] truncate">
                  What is a product description? A product description describes
                  a product.
                </td>
      ...
      <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <div className="flex justify-center items-center space-x-4">
          ...
          <div className="flex justify-center items-start min-h-screen py-10">
            <ul className="w-52 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
